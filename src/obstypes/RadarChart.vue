  ...
  methods: {
    buildStructure(percentage) {
      ...
      for (let count = 0; count < this.statsLength; count++) {
        ...
        let x = calculateXCoordinate(
          newAngle,
          angleMultiplier,
          this.originPoint
        )
        let y = calculateYCoordinate(
          newAngle,
          angleMultiplier,
          this.originPoint
        )
    ...
    externalStrokeWidth() {
      if (objectIsDefined(this.radar)) {
        if (objectHasProperty(this.radar, 'structure')) {
          if (objectHasProperty(this.radar.structure, 'external')) {
            return (
              setProperty(this.radar.structure.external, 'strokeWidth', '4') +
              'px'
            )
          }
        }
      ...
      if (objectIsDefined(this.radar)) {
        if (objectHasProperty(this.radar, 'structure')) {
          if (objectHasProperty(this.radar.structure, 'internals')) {
            return setProperty(
              this.radar.structure.internals,
              'strokeColor',
              '#777777'
            )
          }
    ...
    internalsStrokeWidth() {
      if (objectIsDefined(this.radar)) {
        if (objectHasProperty(this.radar, 'structure')) {
          if (objectHasProperty(this.radar.structure, 'internals')) {
            return (
              setProperty(this.radar.structure.internals, 'strokeWidth', '2') +
              'px'
            )
          }
        }
    ...
    averageStrokeWidth() {
      if (objectIsDefined(this.radar)) {
        if (objectHasProperty(this.radar, 'structure')) {
          if (objectHasProperty(this.radar.structure, 'average')) {
            return (
              setProperty(this.radar.structure.average, 'strokeWidth', '2') +
              'px'
            )
          }
        }
